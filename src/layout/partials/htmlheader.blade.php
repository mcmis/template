<head>
    <meta charset="UTF-8">
    <title> @lang('common.project.name') - @yield('htmlheader_title', 'City Municipal System') </title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta name="csrf_token" content="{{ csrf_token() }}" />

    <!-- Bootstrap 3.3.4 -->
    <link href="{{ ui_asset('/css/bootstrap.css') }}" rel="stylesheet" type="text/css" />
    <!-- Font Awesome Icons -->
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <!-- Ionicons -->
    <link href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
    <link href="{{ ui_asset('/css/AdminLTE.css') }}" rel="stylesheet" type="text/css" />
    ...
    <!-- Jasny Bootstrap -->
    <link href="{{ ui_asset('css/jasny-bootstrap.css') }}" rel="stylesheet" type="text/css" />
    ...
    <!-- jQuery UI - v1.11.4 -->
    <script src="{{ ui_asset('/plugins/jQueryUI/jquery-ui.min.js') }}"></script>
    <!-- Bootstrap 3.3.2 JS -->
